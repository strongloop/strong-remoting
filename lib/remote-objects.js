...
RemoteObjects.prototype.classes = function () {
  ...
  Object
    ...
    .forEach(function (name) {
      result.push(new SharedClass(name, exports[name]));
    });

  Object
    .keys(sharedClasses)
    .forEach(function (name) {
      var sharedClass = sharedClasses[name];
      if(sharedClass instanceof SharedClass) {
        result.push(sharedClass);
      }
    });
 ...
 *
 * ```js
 * remotes.createType('MyType', function(val, ctx) {
