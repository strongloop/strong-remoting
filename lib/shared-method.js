 ...
 * ```js
 * // examples
 * sharedMethod.willInvoke(myClass.myMethod); // pass a function
 * sharedMethod.willInvoke(myClass.prototype.myInstMethod);
 * sharedMethod.willInvoke('myMethod', true); // check for a static method by name 
 * sharedMethod.willInvoke('myInstMethod', false); // instance method by name
 * ```
 *
...
SharedMethod.prototype.willInvoke = function(suspect, isStatic) {
