...
RestAdapter.prototype.createHandler = function () {
  ...
  classes.forEach(function (restClass) {
    ...
    var handleMethodNotFound=!(this.options && this.options.handleMethodNotFound===false);
    if(handleMethodNotFound){
  ...
  var handleUrlNotFound=!(this.options && this.options.handleUrlNotFound===false);
  if(handleUrlNotFound){
