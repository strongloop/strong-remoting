...
RestAdapter.prototype.createHandler = function () {
  ...
  classes.forEach(function (restClass) {
    ...
    var version = restClass.sharedClass.ctor &&
      (restClass.sharedClass.ctor.version ||
        (restClass.sharedClass.ctor.settings &&
          restClass.sharedClass.ctor.settings.version));
